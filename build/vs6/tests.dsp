...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 /nologo /entry:"mainCRTStartup" /subsystem:console /machine:I386 /out:"../../lib/release/tests.exe" /libpath:"../../lib/release"
# ADD LINK32 /nologo /entry:"mainCRTStartup" /subsystem:console /machine:I386 /out:"../../lib/release/tests.exe" /libpath:"../../lib/release"
